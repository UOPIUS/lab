        ...
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <?php if ($_SESSION['role_id'] == 107 || $_SESSION['role_id'] == 106 || $_SESSION['role_id'] == 103): ?>
                    ...
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#inventoryLayoutCollapse"
                        aria-expanded="false" aria-controls="inventoryLayoutCollapse">
                        <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                        Manage inventory
                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>

                    </a>
                    <div class="collapse" id="inventoryLayoutCollapse" aria-labelledby="headingInventory"
                        data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
