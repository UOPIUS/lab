...
<body class="sb-nav-fixed">
                    ...
                    ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="ntr.php?idx=<?=$class->simple_encrypt($t->id)?>" data-xf="<?=$t->tranx_id?>" class="btn btn-warning btn-sm aLink">Click
                                                                for
    ...
    <!--show Test Modal --
    <div class="modal fade" id="showTestModal" role="dialog">
        <div class="modal-dialog modal-dialog-scrollable">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="specimen-used"></div>
                    <div id="test-result"></div>
                    <div id="test-mbody"></div>
    ...
    $("#makeReportModal").on("show.bs.modal", function(event) {
        ...
        var editorObj = $("#templateBody").data('wysihtml5');
        var editor = editorObj.editor;
        editor.setValue(button.data('pformtestdetail'));
        ...
        $("#analyseTestForm").submit(function(e) {
            ...
            posting.done(function(data) {
                ...
                if (200 == result.status) {
                    ...
                    //reflect result on table for user to see...
                    return false;
                }
                $response.html(
    ...
    window.onload = () => {
        document.getElementById('template').addEventListener('change', previewTemplate);
        //document.getElementById('finalSubmit').addEventListener('click', pfTest);
    };
    /*
    function pfTest(e) {
        if (confirm("Are you Sure You Want To Submit This Test Result?") == true) {
            makeXHR(e, responseDiv, 'request/testform_report.php', {
                tst1form: 's1fcnf',
                tests1ftest: this.getAttribute('data-referral'),
                token: document.getElementsByTagName("meta")["csrf_token"].getAttribute("content")
            });
        }
    }
    **/
   //Load template into editable area.
    function previewTemplate() {
        $('#templateBody').data("wysihtml5").editor.setValue(this.value);
    }
    ...
    $(".aLink").click(function(e) { 
        ...
        var url = e.target.href
          $.get("request/vtyn2xASj5fsRteLoqjII7C.php", function(data, status){
            alert("Data: " + data + "\nStatus: " + status);
          });
