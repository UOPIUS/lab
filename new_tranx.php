                                ...
                                <div class="card-body">
                                    <form id="newLabTestForm" method="POST"
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-success btn-block btn-lg" id="finalSubmitTest">
                ...
                .then((proceed) => {
                    if (proceed) {
                        ...
                        const payload = {
                            ...
                            customToken: document.getElementsByTagName("meta")["csrf_token"].getAttribute("content")
                        }
                        ...
                        xhr.onload = function() {
                            if (xhr.status != 200) {
                                ...
                                if (detail.status) {
                                    ...
                                    window.location.href = "https://lab.capitalmedicares.com/client_profile.php?refx="+payload.userRef;
                                } else {
