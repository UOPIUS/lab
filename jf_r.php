...
//if(!(106 == $_SESSION['role_id'] || 101 == $_SESSION['role_id'])) header('location: logout.php');
                            ...
                            <div class="row flex-grow">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-12 col-xl-12">
                                                    <h6 class="mb-2 text-primary">
                                                        <?= number_format($metrix->numerate,0) ?></h6>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-12 col-xl-12">
                                                    <h6 class="mb-2 text-success">
                                                        &#x20A6; <?= number_format($metrix->amount,2) ?></h6>
                                                    <div class="d-flex align-items-baseline">
                                ...
                                <div class="col-md-3 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-baseline">
                                                <h6 class="card-title mb-0 text-warning">Outstanding Debt</h6>
                                                <div class="dropdown mb-2">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-12 col-xl-12">
                                                    <h6 class="mb-2 text-warning" id="outstandingTab"></h6>
                                                    <div class="d-flex align-items-baseline">
                                ...
                                <div class="col-md-3 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-12 col-xl-12">
                                                    <h6 class="mb-2 text-danger" id="totalExpenses">
                                                        <?= number_format($pending->numerate,0) ?></h6>
                                                    <div class="d-flex align-items-baseline">
                                                        <p class="text-warning">
                        ...
                        <div class="col-xl-9">
                            <div class="card mb-4">
                                <div class="card-header"><i class="fas fa-chart-area mr-1"></i>Daily Transaction
                                    Statistics</div>
                                <div class="card-body"><canvas id="myAreaChart" width="100%" height="400"></canvas>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-12 col-md-12 col-xl-12 mb-4">
                                    <div class="card bg-success">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-subtitle mb-2 text-white">Total Test for <?=date('F') ?>
                                            </h6>
                                ...
                                <div class="col-12 col-md-12 col-xl-12 mb-4">
                                    <div class="card bg-danger">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-subtitle mb-2 text-white" id="refundTab"></h6>
                                            <p class="card-text"><i class="fas fa-pen"></i></p>
                                        </div>
                                    </div>
                                </div>
