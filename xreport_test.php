...
<body class="sb-nav-fixed">
    ...
    <script type="text/javascript" src='https://cdn.tiny.cloud/1/z3ot37a9cngzckdy2tyvuvj6o9pmwcuzcpe4awi24mq7uxep/tinymce/6/tinymce.min.js' referrerpolicy="origin"></script>
    <script>
    ...
    function ajaxLoadCat(e){
        ...
        //tinymce.get('editorOne').setContent(button.data('pformtestdetail'));
        tinymce.activeEditor.setContent(button.data('pformtestdetail'));
