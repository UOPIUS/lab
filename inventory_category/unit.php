...
if (NULL !== filter_input(INPUT_GET, 'id') && NULL !== filter_input(INPUT_GET, 's')) {
    ...
    $class->updateStatus('inventory_units', 'id', $id, $new_status);
}
$kindreds = $class->rawQuery("SELECT c.name,c.id,c.status,c.created_at,u.full_name,c.quantity 
FROM users_tbl AS u JOIN inventory_units c ON c.user_id = u.user_id ORDER BY c.created_at DESC");
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h4 class="mt-4">Inventory Categories</h4>
                    <div class="card mb-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                                        ...
                                                        data-name="<?= $vl->name ?>" data-quantity="<?= $vl->quantity ?>">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="<?= htmlentities($_SERVER['PHP_SELF']) ?>" id="krd_form" class="mb-4">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <label for="category">Name of unit: <strong
                                                class="text-danger">*</strong></label>
                                        <input type="text" class="form-control" id='category'>
                                        <input type="hidden" id="token" value="<?= $_SESSION['token'] ?>">
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="category">Quantity Contained: <strong
                                                class="text-danger">*</strong></label>
    ...
    <script>
        window.onload = () => {
            document.getElementById('krd_form').addEventListener('submit', (e) => {
                ...
                makeXHR(e, responseDiv, '../request/inventory_unit.php', {
        ...
        $("#editModal").on("show.bs.modal", function (event) {
            ...
            modal.find(".modal-body input[name=quantity]").val(button.data('quantity'));
