...
if (NULL !== filter_input(INPUT_GET, 'id') && NULL !== filter_input(INPUT_GET, 's')) {
    ...
    $class->updateStatus('inventory_categories', 'id', $id, $new_status);
}
$kindreds = $class->rawQuery("SELECT c.name,c.id,c.status,c.created_at,u.full_name 
FROM users_tbl AS u JOIN inventory_categories c ON c.created_by = u.user_id ORDER BY c.created_at DESC");
...
<head>
    ...
    <title>Inventory Category Setup | <?= $config->name ?></title>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <button class="btn btn-pill btn-danger btn-air-danger float-right"
                                ...
                                <i class="fa fa-plus-circle"></i>&nbsp;Add New Item Category
                            </button>
                        </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="<?= htmlentities($_SERVER['PHP_SELF']) ?>" id="krd_form" class="mb-4">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label for="category">Category of Item: <strong
    ...
    <script>
        window.onload = () => {
            document.getElementById('krd_form').addEventListener('submit', (e) => {
                ...
                makeXHR(e, responseDiv, '../request/inventory_division.php', {
        ...
        $("#editModal").on("show.bs.modal", function (event) {
            ...
            $("#editCat").submit(function (e) {
                ...
                let url = "../request/inventory_division.php";
