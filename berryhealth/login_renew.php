<?php include_once 'functions/Functions.php';
    if ($_SESSION['user_id'] && $_SESSION['role_id']) {
        switch($_SESSION['role_id']):
            ...
            break;
            case '102':
              header('location: acct_dashboard.php'); //account
            break;
            case '103':
              header('location: adhoc_dashboard.php'); //front desk
            break;
            case '105':
                                ...
                                <div class="card-body">
                                    <form id="signinForm">
                                        <div class="form-group"><label class="small mb-1"
                                                for="inputUsername">Activation code</label><input class="form-control py-4" autofocus 
                                                id="inputUsername" type="text" placeholder="Enter Activation token">
                                        </div>
                                        <div class="form-group"><label class="small mb-1"
                                                for="inputPassword">Staff Password</label><input class="form-control py-4"
                                        ...
                                        <div class="text-center">
                                            <button class="btn btn-primary" type="submit"
                                                id="login">Request Activation <i class="fas fa-arrow-right"></i></button>
                                        </div>
                                    </form>
                                </div>
